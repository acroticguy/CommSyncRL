...
BakkesModConfig::BakkesModConfig(std::shared_ptr<CVarManagerWrapper> cvarManager)
    : m_cvarManager(std::move(cvarManager))
{
}

void BakkesModConfig::RegisterCVars() {
